...
const PlotOptions = ({ plotState, setPlotState }: { 
    plotState: PlotState, 
                ...
                <div className={styles.subsection}>
                    ...
                    <div className={styles.subsection}>
                        ...
                        <input
                            ...
                            onChange={(event) => setPlotState({...plotState, toggleLabels: event.target.checked})}
                        />
                    </div>
                    <div className={styles.subsection}>
                        ...
                        <input
                            ...
                            onChange={(event) => setPlotState({...plotState, toggleGridlines: event.target.checked})}
                        />
                    </div>
                </div>
            </div>
